...
public class HalsteadVocabularyCheck extends AbstractCheck {
    ...
    {
    	reportStyleError(aAST, messageBeginning + hashMap.size() + messageEnd);
    }
